...
<script>document.title = 'Entertainment'</script>
...
<div id="carousel-example-generic" class="carousel slide"
		data-ride="carousel">
		<?php
		$urlArticles0 = file_get_contents ( 'https://newsapi.org/v1/articles?source=mtv-news&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				...
				<div class="carousel-caption">
					...
					<div class="carBut">
						<a class="btn btn-theme btn-sm btn-min-block" href="<?= $infoAndArticlesArr0 ['articles'] [1] ['url']; ?>">Learn more</a>
					</div>
				</div>
			</div>
			<div class="item">
				...
				<div class="carousel-caption">
					...
					<div class="carBut">
						<a class="btn btn-theme btn-sm btn-min-block" href="<?= $infoAndArticlesArr0 ['articles'] [2] ['url']; ?>">Learn more</a>
					</div>
				</div>
			</div>
			<div class="item">
				...
				<div class="carousel-caption">
					...
					<div class="carBut">
						<a class="btn btn-theme btn-sm btn-min-block" href="<?= $infoAndArticlesArr0 ['articles'] [3] ['url']; ?>">Learn more</a>
					</div>
				</div>
			</div>
			<div class="item">
				...
				<div class="carousel-caption">
					...
					<div class="carBut">
						<a class="btn btn-theme btn-sm btn-min-block" href="<?= $infoAndArticlesArr0 ['articles'] [4] ['url']; ?>">Learn more</a>
					</div>
				</div>
			</div>
...
<div id="mainExceptCarousel">
	<section id="mainSectionTop">
		<div id="articlesTop">
			...
			<hr />
				<?php
				$urlArticles = file_get_contents ( 'https://newsapi.org/v1/articles?source=reddit-r-all&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
	...
	<aside>
		...
		<div id="asideDiv">
			<ul>
            	<?php
					$urlArticles2 = file_get_contents ( 'https://newsapi.org/v1/articles?source=ign&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
	...
	<section id="mainSectionBottom">
		<div id="articlesBottom">
			...
			<hr />
				<?php
					$urlArticles3 = file_get_contents ( 'https://newsapi.org/v1/articles?source=entertainment-weekly&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
					...
					$urlArticles4 = file_get_contents ( 'https://newsapi.org/v1/articles?source=buzzfeed&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
