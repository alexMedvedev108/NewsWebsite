...
<script>document.title = 'Politics'</script>
...
<div id="mainCarousel">
	...
	<div id="carousel-example-generic" class="carousel slide"
		data-ride="carousel">
		<?php
			$urlArticles0 = file_get_contents ( 'https://newsapi.org/v1/articles?source=the-huffington-post&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
...
<div id="mainExceptCarousel">	
    <section id="mainSectionTop">	
    		<div id="articlesTop">
    			...
    			<hr />
				<?php
					$urlArticles = file_get_contents ( 'https://newsapi.org/v1/articles?source=cnbc&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
    ...
    <aside>
        ...
        <div id="asideDiv">
            <ul>
            	<?php
					$urlArticles2 = file_get_contents ( 'https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
     ...
     <section id="mainSectionBottom">   
		<div id="articlesBottom">
	    	<h1>More articles</h1>
	    		<hr />
				<?php
					$urlArticles3 = file_get_contents ( 'https://newsapi.org/v1/articles?source=cnn&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
					...
					$urlArticles4 = file_get_contents ( 'https://newsapi.org/v1/articles?source=bloomberg&sortBy=top&apiKey=82bd472141f34d36ba85c5389ff1fc16' );
